define(
    [
        ...
        'Mangoit_Onepagecheckout/js/action/set-additional-information',
        'mage/calendar'
    ],
    function ($, ko, Component, quote, setAdditionalInformationAction, calendar) {
        ...
        var hsOscGiftwrap = ko.observable((quote.getTotals().mangoit-onepagecheckout_giftwrap_amount) ? true : false);
        var canShowSurveyOther = ko.observable(false);

        return Component.extend({
            defaults: {
                template: 'Mangoit_Onepagecheckout/additional'
            },
            ...
            initialize: function () {
                ...
                if (this.canShowDeliveryDate) {
                    $("#mangoit-onepagecheckout-delivery-date").calendar({
                        showsTime: false,
                        dateFormat: "M/d/yy",

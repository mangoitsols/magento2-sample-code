define(
    [
        ...
        'Mangoit_Onepagecheckout/js/model/shipping-rates-validator',
        'Magento_Checkout/js/model/shipping-address/form-popup-state',
        'Mangoit_Onepagecheckout/js/model/shipping-service',
        ...
        'uiRegistry',
        'mage/translate',
        'Mangoit_Onepagecheckout/js/model/shipping-rate-service'
    ],
    function (
        $,
        _,
        ...
        return Component.extend({
            defaults: {
                template: 'Mangoit_Onepagecheckout/shipping'
            },
            visible: ko.observable(!quote.isVirtual()),
            errorValidationMessage: ko.observable(false),
            isCustomerLoggedIn: customer.isLoggedIn,
            showShippingStep: ko.observable(window.isShippingStepVisible),
            ...
            initialize: function () {
                ...
                $('body').addClass('mangoit-onepage-checkout').addClass(window.checkoutConfig.onestepcheckoutLayout);
                if (quote.isVirtual()) {
                    $('body').addClass('mangoit-onepage-checkout').addClass('mangoit-onepagecheckout-virtual');
                }

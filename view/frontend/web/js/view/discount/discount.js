...
define(
    [
        ...
        'Mangoit_Onepagecheckout/js/action/set-coupon-code',
        'Mangoit_Onepagecheckout/js/action/cancel-coupon',
        'Mangoit_Onepagecheckout/js/mangoit/components'
    ],
    function ($, ko, Component, quote, setCouponCodeAction, cancelCouponAction) {
        ...
        return Component.extend({
            defaults: {
                template: 'Mangoit_Onepagecheckout/payment/discount'
            },

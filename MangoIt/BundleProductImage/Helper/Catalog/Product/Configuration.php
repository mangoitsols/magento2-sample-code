 ...
 */
namespace MangoIt\BundleProductImage\Helper\Catalog\Product;
                ...
                foreach ($bundleOptions as $bundleOption) {
                    if ($bundleOption->getSelections()) {
                        ...
                        foreach ($bundleSelections as $bundleSelection) {
                            ...
                            if ($qty) {
                                $option['value'][] = $this->escaper->escapeHtml($bundleSelection->getName()) .' '. $qty.' '.$this->escaper->escapeHtml($bundleSelection->getUnitPricePerPerson());

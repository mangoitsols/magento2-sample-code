 ...
 */
namespace MangoIt\Backend\Controller\Adminhtml\Product;
...
class Save extends \Magento\Catalog\Controller\Adminhtml\Product\Save
{
     ...
     *
     * Resolving SL-68 for getting "User Default Value"
     * checkbox selected when selecting products in website.
     * and SL-56 for simple product with required custom options
     *
     * @param array $data
     * @param int $productId
     * @return void
